<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">{{ trans('Expense Management') }}</span>
    </a>
    ...
    @can('expense_access')
        <li class="nav-item">
            <a href="{{ route("admin.expenses.index") }}" class="nav-link {{ request()->is("admin/expenses") || request()->is("admin/expenses/*") ? "active" : "" }}">
                ...
                {{ trans('Expense/Income') }}
            </a>
        </li>
    @endcan
    @can('all_expense_access')
    <li class="nav-item">
        <a href="{{ route("admin.expenses.all-expenses") }}" class="nav-link {{ request()->is("admin/all-expenses") || request()->is("admin/all-expenses/*") ? "active" : "" }}">
            <i class="fa-fw fas fa-file-signature nav-icon">
